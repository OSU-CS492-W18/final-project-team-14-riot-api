...
public class StatsAdapter extends RecyclerView.Adapter<StatsAdapter.StatsItemViewHolder> {
    ...
    public StatsAdapter(Context context, OnForecastItemClickListener clickListener) {
        mContext = context;
    ...
    class StatsItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
