...
import com.example.android.lolstats.R;
...
public class OpenWeatherMapUtils {
     ...
     */
    private final static String OWM_FORECAST_APPID = "83634acc9a441cd619a9b4eb2dfec064";
    ...
    public static String getTemperatureUnitsAbbr(Context context, String temperatureUnitsValue) {
        if (temperatureUnitsValue.equals(context.getString(R.string.pref_region_kelvin_value))) {
            return context.getString(R.string.units_kelvin);
        } else if (temperatureUnitsValue.equals(context.getString(R.string.pref_region_metric_value))) {
